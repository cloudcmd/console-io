 (function() {
    ...
    module.exports.middle           = function(prefix, options) {
        return getServe(prefix, options);
    };
    ...
    function getServe(prefix, options) {
        if (!prefix)
            prefix = '/console';
        
        return serve.bind(null, prefix, options);
    }
    
    function serve(prefix, options, req, res, next) {
        var joinFunc,
            o           = options || {},
